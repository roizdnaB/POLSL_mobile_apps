...
class AllGradesListAdapter(var gradeList: LiveData<List<GradeModel>>, val gradeCallback: ICallbackGrade):
    RecyclerView.Adapter<AllGradesListAdapter.GradeHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GradeHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.grade_list_all_one_row, parent, false)
