...
import kotlinx.android.synthetic.main.student_in_subject_one_row.view.*
import kotlinx.android.synthetic.main.subject_list_one_row.view.*
import kotlinx.android.synthetic.main.subject_list_one_row.view.deleteButton

class StudentListInSubjectAdapter(var studentList: LiveData<List<StudentModel>>, val studentCallback: ICallbackStudent):
    RecyclerView.Adapter<StudentListInSubjectAdapter.StudentHolder>() {

    inner class StudentHolder(view: View): RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): StudentHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.student_in_subject_one_row, parent, false)
